...
| S06 | Production modes/runtime | S07-A data contract + S00 kickoff | C/L/F modes, config, resume, loader, eval | active under O-027 from exact base `968d815`, branch `codex/s06-production-runtime`, xhigh task `019f5434`; compute none at kickoff |
