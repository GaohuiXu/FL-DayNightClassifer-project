...
> `0.25` GH200-hour. STOP-D/E/F and S11+ remain pending.
>
...
| S10 | Centralized-model numerical/architectural health, production recipe selection, final-architecture GH200 optimization, and bounded full clean/fusion claim | closed S08+S09 | STOP-A closed; O-130 B-RAND active after reviewed Job `478250`; C unstarted |
