...
| S06 | Production modes/runtime | S07-A data contract + S00 kickoff | C/L/F modes, config, resume, loader, eval | REVIEW ACTIVE under O-030 at final worker `6b7ef29`; Job `341997` FAILED 45/62 preserved, separate remediation-2 Job `342014` PASS 66/66 bounded synthetic with final manifest; S06-R task `019f546e...`, no integration/full-data/scientific PASS |
