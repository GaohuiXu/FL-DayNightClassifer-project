...
| S06 | Production modes/runtime | S07-A data contract + S00 kickoff | C/L/F modes, config, resume, loader, eval | CHANGES-REQUESTED under O-028 at delivery `8acfbfe`; unexecuted requests rejected; fixed-window exposure and fail-atomic checkpoint remediation active, no compute |
