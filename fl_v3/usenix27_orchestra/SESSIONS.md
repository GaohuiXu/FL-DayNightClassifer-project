...
| S07 | Integrated engineering gate | phase A: S01 PASS; phase B: S01-S06 PASS | staged data foundation, then one resolved candidate stack and 100/1000-step evidence | S07-A reviewed PASS at `ba15716`/`44cefd0`/`370ea6c`; T5 caller-order remediation is final `b6d1320` after R2 `afb81f5`; independent S07-B-R3 is ACTIVE under O-040. No compute or runtime/full cache/100/1000/profile PASS yet |
