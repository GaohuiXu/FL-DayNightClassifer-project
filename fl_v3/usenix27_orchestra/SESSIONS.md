...
| S10 | Centralized-model numerical/architectural health, production recipe selection, final-architecture GH200 optimization, and bounded full clean/fusion claim | closed S08+S09 | STOP-A closed; Job `478250` reviewed baseline-instability FAIL, owner rebaseline required; C unstarted |
