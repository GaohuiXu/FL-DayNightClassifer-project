...
> identity, tests, data or split work. O-126's one submission is consumed and STOP-A
> is blocked pending a resource amendment; STOP-B/C have not started. STOP-D/E/F execution, merge,
...
| STOP-A/B/C implementation, commit, isolated review topology, Slurm tuple and cumulative budget | O-126's sole CPU-only submission was site-transformed and cancelled; replacement resource authority is now required; STOP-B/C remain unstarted |
