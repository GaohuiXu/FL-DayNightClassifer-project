...
> the 33-run integrity gate, and returned `MIXED_INCONCLUSIVE`: both intended
> camera stochasticity and same-seed LiDAR runtime variation qualify. Review is
> pending and no further compute is executable. STOP-C has not started. STOP-D/E/F execution, merge,
