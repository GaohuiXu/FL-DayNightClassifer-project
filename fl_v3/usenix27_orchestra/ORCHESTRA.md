...
> GH200-hour. STOP-C has not started. STOP-D/E/F execution, merge,
...
| STOP-A/B/C implementation, commit, isolated review topology, Slurm tuple and cumulative budget | STOP-A closed; O-128 Job `477892` consumed B-DIAG and failed before localization; no executable tuple; STOP-C unstarted |
