...
> B-REFINE is not triggered and evidence review is pending. STOP-C has not
> started. STOP-D/E/F execution, merge,
...
| STOP-A/B/C implementation, commit, isolated review topology, Slurm tuple and cumulative budget | STOP-A closed; O-129 Job `478250` calibrated baseline-instability FAIL, review pending, no executable compute; STOP-C unstarted |
