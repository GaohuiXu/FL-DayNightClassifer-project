...
> O-132 now authorizes exactly one full C0-v2 clean replay from source `2262b40`
> on one GH200 for at most one hour, with no retry and no intermediate reviewer
> chain. This replaces only the failed C0 execution; later C/D/E/F remain gated.
...
accepted clean engineering anchor 2a58405
                  ...
                  │
                  ├── S10 A-F CL health/recipe/speed/full claim     [A CLOSED; B CLOSED INCONCLUSIVE]
...
| STOP-A/B/C implementation, commit, isolated review topology, Slurm tuple and cumulative budget | STOP-A closed; STOP-B closed `INCONCLUSIVE`; O-131 C0 Job `492525` remains negative evidence, and O-132 authorizes the one exact §27 C0-v2 clean replay; later C remains owner-gated |
