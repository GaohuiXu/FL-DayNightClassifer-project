...
> S00 must freeze a new detached read-only snapshot, hashes, fresh output and
> literal command before submission. There is no retry or automatic C1-B
> continuation.
>
