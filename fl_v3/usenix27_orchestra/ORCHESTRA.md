...
> non-selectable epoch-4 `D_select` peek. Independent review of `296ef9b...` closed
> `PASS_WITH_RESIDUAL_RISK` with no open P0-P2; explicit owner activation of the
> review-seal commit remains required. No job is currently active.
...
`RUN_REQUEST.md` Section 7.4.7 is a pending parallel amendment for unchanged Camera
plus a zero-update LiDAR diagnostic. Its independent review closed at `296ef9b...`
with no open P0-P2; explicit owner activation of the review-seal commit is the next
gate, and no job is active. S11+ remains undefined and pending.
