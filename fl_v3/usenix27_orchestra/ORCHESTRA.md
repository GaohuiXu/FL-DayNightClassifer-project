...
> detached snapshot/command tuple are frozen in S10 `RUN_REQUEST.md` §24 and
> ready for one no-retry submission. STOP-C has not started. STOP-D/E/F execution, merge,
