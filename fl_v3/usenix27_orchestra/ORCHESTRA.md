...
> and owner decision O-025 now selects the version-guarded spconv-only
> training-dispatch-under-no-grad remediation. S04 implementation/revalidation is
> active and is not yet PASS. S05 preserved failed Job
...
- **S04:** Job `335566` failed five composition cases; remediation Job `335579`
  ...
  `49f26de`. O-025 selects a narrowly scoped workaround: keep the encoder and
