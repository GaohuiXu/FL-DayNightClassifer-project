...
> remain unauthorized.
> O-135 authorizes only the diagnosed BN1d state-mapping assertion correction
> and its regression test. The remediation is unexecuted and uncommitted; O-135
> grants no replacement compute or automatic C1-B continuation.
>
