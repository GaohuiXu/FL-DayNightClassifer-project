...
**Read first, in order:**
1. `fl_v3/docs/roadmap/cycle_04_fusion_layer_backdoors.md` — the full approved plan (skim all; focus
...
3. `fl_v3/docs/cycle_04/decisions.md` — the confirmed D1–D8 (honor them).
4. `fl_v3/docs/cycle_04/tasks/T0_SPEC.md` — **your contract for this task.**
...
- Write your SPEC to `fl_v3/collab/T0/SPEC.md` (from `fl_v3/collab/SPEC_TEMPLATE.md`),
