...
| 04 | 2026-06-15 → TBD | **Clean federated multimodal AD perception foundation** — camera/LiDAR/fusion detection on nuScenes with resolved runtime, official evaluation, and clean FedAvg. The active protocol and security sequencing are governed only by the Orchestra. | **active** | S07 clean engineering is closed; S08 precision and S09 performance/readiness gate centralized capability work. |
...
> with [milestone contracts](../../usenix27_orchestra/SESSIONS.md) and
> [active envelopes](../../usenix27_orchestra/KICKOFFS.md). `fl_v3/collab/` is
...
2. [`../../usenix27_orchestra/SESSIONS.md`](../../usenix27_orchestra/SESSIONS.md) and [`../../usenix27_orchestra/KICKOFFS.md`](../../usenix27_orchestra/KICKOFFS.md) — active milestone and execution envelopes.
3. [`../cycle_04/decisions.md`](../cycle_04/decisions.md) — frozen historical decisions for provenance only; not active authority.
