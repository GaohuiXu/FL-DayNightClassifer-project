...
def main() -> None:
    ...
    report = {
        ...
        "manifest_member_occurrences": summary["member_count"],
        "manifest_unique_members": summary["unique_member_count"],
        "manifest_duplicate_occurrences": summary["duplicate_occurrence_count"],
