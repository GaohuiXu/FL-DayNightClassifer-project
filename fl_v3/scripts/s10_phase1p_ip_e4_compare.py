#!/usr/bin/env python3
"""Seal the exact same-allocation IP-E4 vectorized-geometry comparison."""
...
def main() -> None:
    ...
    result = compare_ip_e4_vectorized_geometry_output_dirs(
    ...
    print(
        json.dumps(
            {
                "status": "COMPLETE_IP_E4_VECTORIZED_GEOMETRY_COMPARISON",
                "verdict": gate["verdict"],
                "promoted_by_owner_gate": gate["promoted_by_owner_gate"],
                "conditional_bulk_input_conversion_implementation_eligible": gate[
                    "conditional_bulk_input_conversion_implementation_eligible"
                ],
