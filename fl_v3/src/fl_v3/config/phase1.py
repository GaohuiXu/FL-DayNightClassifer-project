...
FROZEN_CAMERA_AUGMENTATION: dict[str, Any] = {
    ...
    "scene_3d": {
        ...
        "train_horizontal_flip_probability": 0.5,
        "train_vertical_flip_probability": 0.0,
        "eval_scale": [1.0, 1.0],
...
def _validate_training(raw: Any) -> None:
    ...
    expected = {
        ...
        "cbgs_samples_per_epoch": 78470,
        "consumed_samples_per_epoch": 78464,
        "dropped_samples_per_epoch": 6,
        "optimizer_updates_per_epoch": 2452,
        "max_optimizer_updates": 49040,
...
def _validate_sampling(raw: Any) -> None:
    sampling = _keys(
        raw,
        {
            "type", "class_order", "rng", "source_sample_order_sha256",
    ...
    expected = {
        "type": "official_cbgs",
        "class_order": list(NUSCENES_CLASSES),
        ...
        "class_pool_sizes": [19114, 12136, 4107, 4107, 4320, 5083, 3721, 3722, 14900, 7269],
        "duplicated_class_memberships": 78479,
        "target_class_fraction": 0.1,
        "segment_sizes": [7847] * 10,
        "expanded_length": 78470,
        "expanded_indices_sha256": "cf31d1245724b87475843051982d9a2e28db928b3f576fbf777cf358d9ce1c47",
        "expanded_tokens_sha256": "e7f5e6977d7565f12801ac38c391fc20e1fc3978fe18f8b0812aceada7fccb3e",
        "class_segments_sha256": "6bf15ccef540a22c0a0119e63a5be2454bf7d62c0ce3451d6271f9b49c01d3c4",
        "epoch_shuffle": {"api": "numpy.random.RandomState", "seed_formula": "seed_plus_zero_based_epoch", "permutation_domain": "expanded_position", "remainder_policy": "drop_last_6_to_effective_b32"},
        "twenty_epoch_order_sha256": "9a9bc8fd07855917ec23dd8d26b408c7a25d0d0f2a2bb6c2f30a2d79588d05a6",
        "twenty_epoch_remainder_sha256": "c163eaeb16386f455a625e4171f1e722ce75f36415755ab373325b91cf4431a7",
    }
...
def _validate_gt_paste(raw: Any, branch: str, lifecycle: str) -> None:
    ...
    if branch == "camera":
        expected = {
            ...
            "all_classes": list(NUSCENES_CLASSES),
            "min_points": {name: 5 for name in NUSCENES_CLASSES},
...
def validate_phase1_config(raw: Mapping[str, Any]) -> dict[str, Any]:
    ...
    root = _keys(
        dict(raw),
        {
            "schema_version", "contract", "model", "initialization", "precision",
